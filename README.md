...
<div align="center">
  <img src="https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=600&size=16&duration=3000&pause=800&color=58A6FF&center=true&vCenter=true&multiline=true&width=600&height=70&lines=Building+affordable+healthcare+tech+for+Pakistan+%F0%9F%87%B5%F0%9F%87%B0;EMG+Robotics+%C2%B7+Medical+AI+%C2%B7+FPGA+%C2%B7+Bioinformatics" alt="Typing SVG" />
</div>
...
building at the intersection of embedded systems, ML, and computational biology.
My goal is making diagnostic and rehabilitation technology accessible
in low-resource healthcare settings across Pakistan.

- 🏥 **MalariaSense** — FICS International Stage 3 Finalist
- 📰 **IEEE ICIT 2026** — Accepted paper on facial recognition AI
- 🤖 **NeuroRevive** — EMG soft robotic glove for stroke rehab (FYP)
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><b>🎓 HAZIRI</b></td>
      <td>Facial recognition attendance · RetinaFace + InsightFace · IEEE ICIT 2026 accepted</td>
      <td><code>Django</code> <code>InsightFace</code> <code>RetinaFace</code></td>
      <td><i>Coming soon</i></td>
    </tr>
    <tr>
      <td><b>🧬 HG002 Variant Calling</b></td>
      <td>Nextflow DSL2 long-read variant calling · DeepVariant + Clair3 · GIAB benchmarked on HPC</td>
    ...
    <tr>
      ...
      <td>Linux booted on custom LiteX/VexRiscv SoC synthesized on Nexys A7-100T</td>
    ...
    <tr>
      ...
      <td>8-channel EMG soft robotic glove for post-stroke hand rehabilitation (FYP)</td>
...
I'm open to research collaborations in **medical AI**, **affordable healthcare devices**,
